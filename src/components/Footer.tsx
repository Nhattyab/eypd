...
export default function Footer({ onNewsletterSubmit, onNavigate }: FooterProps) {
  ...
  return (
    <footer className="relative bg-[#181f2a] text-gray-300 font-sans mt-24" id="contact">
      
      {/* 1. Overlapping Ribbon Callout Bar */}
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="bg-gradient-to-r from-[#111e38] via-[#10352c] via-[#0e4d2d] to-[#111e38] rounded-[28px] py-6 px-6 sm:px-10 lg:px-12 shadow-2xl -translate-y-12">
