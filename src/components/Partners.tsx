...
const partnersData: PartnerItem[] = [
  {
    ...
    content: (
      <div className="flex items-center justify-center text-gray-400 group-hover:text-gray-800 transition-colors duration-300 select-none">
        ...
        <span className="font-sans font-bold text-lg tracking-tight">GitHub</span>
      </div>
    )
  },
  {
    ...
    content: (
      <div className="flex items-center justify-center text-gray-400 group-hover:text-gray-800 transition-colors duration-300 select-none">
        ...
        <span className="font-sans font-medium text-xl tracking-tight">Qualia</span>
      </div>
    )
  },
  {
  ...
  },
  {
    ...
    content: (
      <div className="flex items-center justify-center text-gray-400 group-hover:text-gray-800 transition-colors duration-300 select-none">
        <span className="font-sans font-medium text-lg tracking-tight lowercase">formlabs</span>
        <svg
          viewBox="0 0 24 24"
